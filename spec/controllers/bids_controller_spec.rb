  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved bid as @bid" do
        ...
        post :create, {:bid => { "auction" => "invalid value" }}, valid_session
        assigns(:bid).should be_a_new(Bid)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested bid" do
        ...
        Bid.any_instance.should_receive(:update_attributes).with({ "auction" => "" })
        put :update, {:id => bid.to_param, :bid => { "auction" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the bid as @bid" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Bid.any_instance.stub(:save).and_return(false)
        put :update, {:id => bid.to_param, :bid => { "auction" => "invalid value" }}, valid_session
        assigns(:bid).should eq(bid)
      end
