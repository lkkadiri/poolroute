...
describe AuctionsController do
  ...
  def valid_attributes
    { "start_time" => "2013-02-09 21:40:09" }
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved auction as @auction" do
        ...
        post :create, {:auction => { "start_time" => "invalid value" }}, valid_session
        assigns(:auction).should be_a_new(Auction)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested auction" do
        ...
        Auction.any_instance.should_receive(:update_attributes).with({ "start_time" => "2013-02-09 21:40:09" })
        put :update, {:id => auction.to_param, :auction => { "start_time" => "2013-02-09 21:40:09" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the auction as @auction" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Auction.any_instance.stub(:save).and_return(false)
        put :update, {:id => auction.to_param, :auction => { "start_time" => "invalid value" }}, valid_session
        assigns(:auction).should eq(auction)
      end
